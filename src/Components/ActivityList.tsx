  ...
  return (
    <>
        ...
        {activities.map(activity => (
            <div key={activity.id} className='flex justify-between bg-white mt-5 border-b border-slate-300 px-5 py-10'>
                ...
                <div className='flex gap-5 items-center'>
                    <button onClick={() => dispatch({ type: "set-active", payload: { id: activity.id } })}>
                        <PencilSquareIcon className='w-8 h-8 text-slate-400' />
                    </button>
                </div>
